...
class UserRepository(MongoDBConn):
    ...
    def get_user_id(self, name):
        try:
            ...
            print("UserRepository: Error fetching user id", error)
            raise Exception("UserRepository: Error fetching user id")
    ...
    def create_user(self, name):
        ...
        try:
            ...
            print("UserRepository: Failed to create new user", error)
            raise Exception("UserRepository: Failed to create new user")
    ...
    def update_user_review_list_add(self, user_id, review_id):
        try:
            ...
            print("UserRepository: Failed to add review in review list", error)
            raise Exception(
                "UserRepository: Failed to add review in review list")
